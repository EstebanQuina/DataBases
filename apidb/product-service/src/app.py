...
# curl -v http://localhost:7002/products/1
...
#curl --headType: application/json" --request POST --data "{\"name\":\"Product3\"}" -v http://localhost:7002/product
...
# curl --request DELETE -v http://localhost:7002/product2
